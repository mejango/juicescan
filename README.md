...
- **UI smoke** (`test/ui-smoke.mjs`) — drives the live app over CDP and asserts the create-flow steps, accounting pills, the approval condition + split lock, and deploy gating.
